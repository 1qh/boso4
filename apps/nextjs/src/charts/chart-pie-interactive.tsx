...
import { ChartContainer, ChartStyle, ChartTooltip, ChartTooltipContent } from '@a/ui/chart'
...
export const ChartPieInteractive = () => {
  const id = 'pie-interactive',
    [activeMonth, setActiveMonth] = React.useState(desktopData[0]?.month),
    activeIndex = React.useMemo(
      () => desktopData.findIndex(item => item.month === activeMonth),
      [activeMonth]
    ),
    months = React.useMemo(() => desktopData.map(item => item.month), [])
